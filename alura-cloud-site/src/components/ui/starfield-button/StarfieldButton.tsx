...
/* eslint-disable @typescript-eslint/no-explicit-any, @next/next/no-img-element, react-hooks/refs -- vendored component (OriginKit), kept as-authored */
"use client"
 ...
 */
function OriginkitBaseStarfieldButton(props: StarfieldButtonProps) {
    const {
        label = "STARFIELD",
        font = {
            variant: "Regular",
...
export default function StarfieldButton(props: Record<string, unknown>) {
  return <OriginkitBaseStarfieldButton {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
